...
export default function ProductCatalog({
  ...
  const handleSubmitNewProduct = async (e) => {
    ...
    try {
      ...
      // Upload to Supabase storage bucket 'product-images' if file selected
      if (imageFile) {
                      ...
                      {isDeleting ? (
                        <div className="flex items-center gap-1.5 animate-scale-up">
                          ...
                          <button
                            ...
                            className="px-2 py-1 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-300 text-[11px] font-semibold transition"
                          >
                            Cancel
                          </button>
                        </div>
